import { Gender, PatientType } from "../type";
// import toNewPatientType from "../utils/toNewPatientType";
...
// const patientEntries: PatientType[] = patients.map((obj) => {
//   const object = {
//     ...toNewPatientType(obj),
//     id: obj.id,
